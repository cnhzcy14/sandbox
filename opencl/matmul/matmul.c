...
#include "common/device_picker.h"
...
//--------------------------------------------------------------------------------
    kernelsource = getKernelSource("/home/cnhzcy14/work/project/sandbox/opencl/matmul/C_elem.cl");
...
//--------------------------------------------------------------------------------
    kernelsource = getKernelSource("/home/cnhzcy14/work/project/sandbox/opencl/matmul/C_row.cl");
    // Create the comput program from the source buffer
    program = clCreateProgramWithSource(context, 1, (const char **) & kernelsource, NULL, &err);
...
//--------------------------------------------------------------------------------
    kernelsource = getKernelSource("/home/cnhzcy14/work/project/sandbox/opencl/matmul/C_row_priv.cl");
    // Create the comput program from the source buffer
    program = clCreateProgramWithSource(context, 1, (const char **) & kernelsource, NULL, &err);
...
//--------------------------------------------------------------------------------
    kernelsource = getKernelSource("/home/cnhzcy14/work/project/sandbox/opencl/matmul/C_row_priv_bloc.cl");
    // Create the comput program from the source buffer
    program = clCreateProgramWithSource(context, 1, (const char **) & kernelsource, NULL, &err);
...
//--------------------------------------------------------------------------------
    kernelsource = getKernelSource("/home/cnhzcy14/work/project/sandbox/opencl/matmul/C_block_form.cl");
    // Create the comput program from the source buffer
    program = clCreateProgramWithSource(context, 1, (const char **) & kernelsource, NULL, &err);
