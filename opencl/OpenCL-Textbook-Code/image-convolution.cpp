...
static const char* inputImagePath = "/home/radax/work/data/cat.bmp";
...
int main() 
{
   ...
   try 
   {
      ...
      std::ifstream sourceFile("/home/radxa/work/project/sandbox/opencl/OpenCL-Textbook-Code/image-convolution.cl");
