...
int main( int argc, char *argv[] )
{
    ...
    Ptr<cv::cuda::FarnebackOpticalFlow> dflow = cv::cuda::FarnebackOpticalFlow::create(numLevels, pyrScale, fastPyramids, winSize, numIters, polyN, polySigma);
    ...
    while( frame1.empty() == false )
    {
        ...
        if( nframes >= 1 )
        {
            ...
            drawMotionField(flow_parts[0],flow_parts[1],motion_flow,15,15,.0,1.0,CV_RGB(0,255,0));
